...
class ResourceDefinition:
    ...
    #             yield t
    #         else:
    #             for type_arg in typing.get_args(t):  # type: ignore[attr-defined]
    #                 yield from collect_reference_option_types(type_arg)

    #     def collect_references(
    #         config,
    #     ) -> Iterable[Tuple[T, Type[ResourceReferenceOption]]]:
    #         """
    ...
    #                 type_origin = typing.get_origin(t)  # type: ignore[attr-defined]
    #                 type_args = tuple(set(typing.get_args(t)) - {type(None)})  # type: ignore[attr-defined]
    #                 if (
